...
\begin{figure}[t]
    \centerline{\includegraphics[width=0.88\columnwidth]{Untitled Diagram.png}}
...
\begin{figure}[t]
    \centerline{\includegraphics[width=0.88\columnwidth]{dataset visualization.png}}
    \caption{Distribution of image samples across the four citrus fruit classes.}
    \label{fig:class}
\end{figure}

\begin{figure}[t]
    \centerline{\includegraphics[width=0.88\columnwidth]{Sample images.png}}
...
\begin{figure}[t]
    \centerline{\includegraphics[width=0.72\columnwidth]{Dataset Spilt.png}}
...
\begin{figure}[t]
    \centerline{\includegraphics[width=0.72\columnwidth]{Pre-trained Process Diagram.png}}
...
\begin{figure}[t]
    \centerline{\includegraphics[width=0.88\columnwidth]{Tensorflow architecture.png}}
...
\begin{figure}[t]
    \centerline{\includegraphics[width=0.88\columnwidth]{Confusion Matrix of all models.png}}
...
\begin{figure}[t]
    \centerline{\includegraphics[width=0.88\columnwidth]{Performance metrics.png}}
